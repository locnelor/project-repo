...
export const makePageModel = (handle?: (where: any, user: sys_user) => any) =>
  (Object.keys(Prisma.ModelName) as Prisma.ModelName[]).reduce(
    (pre, cur) => {
      const page = async (
        {
          pageNo,
...
export const prisma = new PrismaClient()
  .$extends(autoTimestampAndUUIDExtension)
